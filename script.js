...
function agregarTarea( tarea,id,realizado,eliminado) {
    ...
    <i class='bx bx-circle ${REALIZADO}' data="realizado" id="${id}"></i>
...
var typed = new Typed(".hola", {

    strings: ["Hola!", "Realiza", "Tus apuntes", "Sin Registrarte", 
    "Grupo DEVCODE"],
    typeSpeed:65,
    backSpeed: 55,
    loop:true
...
window.addEventListener("scroll", () => {
  ...
  if (scrollPosition > 0) {
    myFooter.style.opacity = "0"; /* desvanecer el footer */
  } else {
    myFooter.style.opacity = "1"; /* restaurar la opacidad del footer */
  }
});
